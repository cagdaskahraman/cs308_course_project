...
const productSeedInput: ProductSeedInput[] = [
  { name: 'Apple iPhone 15', category: 'Phone', price: 54999, stockQuantity: 1, imageUrl: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&w=800&q=80', description: '128GB smartphone with OLED display and dual camera.', model: 'iPhone 15', serialNumber: 'SN-PH-0001', warrantyStatus: '2 years', distributorInfo: 'Apple TR - Apple Turkey Distribution, Istanbul', popularity: 95 },
  ...
  { name: 'Apple MacBook Air 13', category: 'Laptop', price: 55999, stockQuantity: 1, imageUrl: 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?auto=format&fit=crop&w=800&q=80', description: 'Lightweight laptop with all-day battery life.', model: 'MacBook Air 13', serialNumber: 'SN-LP-0002', warrantyStatus: '2 years', distributorInfo: 'Apple TR - Apple Turkey Distribution, Istanbul', popularity: 88 },
  ...
  { name: 'HP Spectre x360', category: 'Laptop', price: 57999, stockQuantity: 1, imageUrl: 'https://images.unsplash.com/photo-1593642634524-b40b5baae6bb?auto=format&fit=crop&w=800&q=80', description: 'Convertible laptop with touch and pen support.', model: 'Spectre x360', serialNumber: 'SN-LP-0004', warrantyStatus: '2 years', distributorInfo: 'HP Turkey, Istanbul', popularity: 50 },
  ...
  { name: 'UGREEN 100W GaN Charger', category: 'Accessory', price: 1999, stockQuantity: 0, imageUrl: 'https://images.unsplash.com/photo-1625842268584-8f3296236761?auto=format&fit=crop&w=800&q=80', description: 'Fast multi-port charger for phone and laptop.', model: 'Nexode 100W', serialNumber: 'SN-AC-0006', warrantyStatus: '2 years', distributorInfo: 'UGREEN Group Ltd, Shenzhen', popularity: 33 },
  ...
  { name: 'Microsoft Surface Pro 10', category: 'Tablet', price: 45999, stockQuantity: 1, imageUrl: 'https://images.unsplash.com/photo-1585790050230-5dd28404ccb9?auto=format&fit=crop&w=800&q=80', description: '2-in-1 tablet-laptop device for professionals.', model: 'Surface Pro 10', serialNumber: 'SN-TB-0006', warrantyStatus: '1 year', distributorInfo: 'Microsoft TR, Istanbul', popularity: 63 },
  ...
  { name: 'Amazon Fire Max 11', category: 'Tablet', price: 8999, stockQuantity: 13, imageUrl: 'https://images.unsplash.com/photo-1561154464-82e9adf32764?auto=format&fit=crop&w=800&q=80', description: 'Entry-level tablet suitable for basic media use.', model: 'Fire Max 11', serialNumber: 'SN-TB-0008', warrantyStatus: '1 year', distributorInfo: 'Amazon EU, Luxembourg', popularity: 23 },
];
