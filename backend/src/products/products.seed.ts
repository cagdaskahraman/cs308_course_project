...
const productSeedInput: ProductSeedInput[] = [
  ...
  { name: 'Oppo Reno 11', category: 'Phone', price: 22999, stockQuantity: 11, imageUrl: 'https://images.unsplash.com/photo-1605236453806-6ff36851218e?auto=format&fit=crop&w=800&q=80', description: 'Balanced smartphone for daily productivity and media.', model: 'Reno 11', serialNumber: 'SN-PH-0008', warrantyStatus: '2 years', distributorInfo: 'Oppo TR, Istanbul' },

  { name: 'Lenovo Legion 5 Pro', category: 'Laptop', price: 62999, stockQuantity: 5, imageUrl: 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?auto=format&fit=crop&w=800&q=80', description: 'Gaming laptop with high refresh display.', model: 'Legion 5 Pro', serialNumber: 'SN-LP-0001', warrantyStatus: '2 years', distributorInfo: 'Lenovo TR, Istanbul' },
  ...
  { name: 'Acer Swift Go 14', category: 'Laptop', price: 40999, stockQuantity: 9, imageUrl: 'https://images.unsplash.com/photo-1593642634524-b40b5baae6bb?auto=format&fit=crop&w=800&q=80', description: 'Daily use ultrabook with OLED display.', model: 'Swift Go 14', serialNumber: 'SN-LP-0006', warrantyStatus: '2 years', distributorInfo: 'Acer TR, Istanbul' },
  { name: 'MSI Creator M16', category: 'Laptop', price: 51999, stockQuantity: 6, imageUrl: 'https://images.unsplash.com/photo-1541807084-5c52b6b3adef?auto=format&fit=crop&w=800&q=80', description: 'Content creation focused laptop with strong CPU.', model: 'Creator M16', serialNumber: 'SN-LP-0007', warrantyStatus: '2 years', distributorInfo: 'MSI EMEA, Amsterdam' },
  ...
  { name: 'Samsung Galaxy Buds2 Pro', category: 'Headphone', price: 5499, stockQuantity: 14, imageUrl: 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?auto=format&fit=crop&w=800&q=80', description: 'Compact earbuds with active noise cancellation.', model: 'Galaxy Buds2 Pro', serialNumber: 'SN-HP-0005', warrantyStatus: '1 year', distributorInfo: 'Samsung Electronics TR, Istanbul' },
  { name: 'JBL Tune 770NC', category: 'Headphone', price: 3999, stockQuantity: 16, imageUrl: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=800&q=80', description: 'Value focused wireless ANC headphones.', model: 'Tune 770NC', serialNumber: 'SN-HP-0006', warrantyStatus: '1 year', distributorInfo: 'Harman International TR, Istanbul' },
  { name: 'Anker Soundcore Q45', category: 'Headphone', price: 4599, stockQuantity: 10, imageUrl: 'https://images.unsplash.com/photo-1612444530582-fc66183b16f7?auto=format&fit=crop&w=800&q=80', description: 'Strong noise cancellation at mid-range price.', model: 'Soundcore Q45', serialNumber: 'SN-HP-0007', warrantyStatus: '18 months', distributorInfo: 'Anker Innovations EMEA, Berlin' },
  ...
  { name: 'Logitech MX Master 3S', category: 'Accessory', price: 4299, stockQuantity: 20, imageUrl: 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?auto=format&fit=crop&w=800&q=80', description: 'Wireless productivity mouse for professionals.', model: 'MX Master 3S', serialNumber: 'SN-AC-0001', warrantyStatus: '2 years', distributorInfo: 'Logitech Europe SA, Lausanne' },
  { name: 'Logitech MX Keys S', category: 'Accessory', price: 4799, stockQuantity: 15, imageUrl: 'https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?auto=format&fit=crop&w=800&q=80', description: 'Backlit keyboard for multi-device workflow.', model: 'MX Keys S', serialNumber: 'SN-AC-0002', warrantyStatus: '2 years', distributorInfo: 'Logitech Europe SA, Lausanne' },
  { name: 'Razer DeathAdder V3', category: 'Accessory', price: 3199, stockQuantity: 12, imageUrl: 'https://images.unsplash.com/photo-1615663245857-ac93bb7c39e7?auto=format&fit=crop&w=800&q=80', description: 'Ergonomic gaming mouse with high precision sensor.', model: 'DeathAdder V3', serialNumber: 'SN-AC-0003', warrantyStatus: '2 years', distributorInfo: 'Razer Europe, Hamburg' },
  { name: 'SteelSeries Apex 7', category: 'Accessory', price: 5999, stockQuantity: 6, imageUrl: 'https://images.unsplash.com/photo-1518773553398-650c184e0bb3?auto=format&fit=crop&w=800&q=80', description: 'Mechanical keyboard with OLED smart display.', model: 'Apex 7', serialNumber: 'SN-AC-0004', warrantyStatus: '2 years', distributorInfo: 'SteelSeries EMEA, Copenhagen' },
  ...
  { name: 'Samsung Galaxy Tab S9', category: 'Tablet', price: 28999, stockQuantity: 5, imageUrl: 'https://images.unsplash.com/photo-1561154464-82e9adf32764?auto=format&fit=crop&w=800&q=80', description: 'AMOLED tablet suited for media and note-taking.', model: 'Galaxy Tab S9', serialNumber: 'SN-TB-0002', warrantyStatus: '2 years', distributorInfo: 'Samsung Electronics TR, Istanbul' },
  { name: 'Lenovo Tab P12', category: 'Tablet', price: 14999, stockQuantity: 12, imageUrl: 'https://images.unsplash.com/photo-1589739900243-4b52cd9dd9d1?auto=format&fit=crop&w=800&q=80', description: 'Large-screen tablet for study and entertainment.', model: 'Tab P12', serialNumber: 'SN-TB-0003', warrantyStatus: '2 years', distributorInfo: 'Lenovo TR, Istanbul' },
  { name: 'Xiaomi Pad 6', category: 'Tablet', price: 13999, stockQuantity: 10, imageUrl: 'https://images.unsplash.com/photo-1585790050230-5dd28404ccb9?auto=format&fit=crop&w=800&q=80', description: 'Value-focused tablet with smooth display.', model: 'Pad 6', serialNumber: 'SN-TB-0004', warrantyStatus: '2 years', distributorInfo: 'Xiaomi TR, Istanbul' },
  ...
  { name: 'Microsoft Surface Pro 10', category: 'Tablet', price: 45999, stockQuantity: 4, imageUrl: 'https://images.unsplash.com/photo-1517059224940-d4af9eec41e5?auto=format&fit=crop&w=800&q=80', description: '2-in-1 tablet-laptop device for professionals.', model: 'Surface Pro 10', serialNumber: 'SN-TB-0006', warrantyStatus: '1 year', distributorInfo: 'Microsoft TR, Istanbul' },
  { name: 'Honor Pad 9', category: 'Tablet', price: 10999, stockQuantity: 11, imageUrl: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=800&q=80', description: 'Affordable tablet with quad speakers and big battery.', model: 'Pad 9', serialNumber: 'SN-TB-0007', warrantyStatus: '2 years', distributorInfo: 'Honor Device Co., Shenzhen' },
  { name: 'Amazon Fire Max 11', category: 'Tablet', price: 8999, stockQuantity: 13, imageUrl: 'https://images.unsplash.com/photo-1573894996493-16b4f3ad2fbb?auto=format&fit=crop&w=800&q=80', description: 'Entry-level tablet suitable for basic media use.', model: 'Fire Max 11', serialNumber: 'SN-TB-0008', warrantyStatus: '1 year', distributorInfo: 'Amazon EU, Luxembourg' },
];
